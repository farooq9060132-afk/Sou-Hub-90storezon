...
export const trackToolUsage = async (trackToolBody: TrackToolBody, options?: RequestInit): Promise<MessageResponse> => {
...
export const getTrackToolUsageMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof trackToolUsage>>, TError,{data: BodyType<TrackToolBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof trackToolUsage>>, TError,{data: BodyType<TrackToolBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof trackToolUsage>>, {data: BodyType<TrackToolBody>}> = (props) => {
          const {data} = props ?? {};
 ...
 * @summary Track tool usage event
 */
export const useTrackToolUsage = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof trackToolUsage>>, TError,{data: BodyType<TrackToolBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
...
export const getToolStats = async ( options?: RequestInit): Promise<ToolStat[]> => {
...
export const trackPageView = async (trackPageViewBody: TrackPageViewBody, options?: RequestInit): Promise<MessageResponse> => {
...
export const submitContact = async (contactBody: ContactBody, options?: RequestInit): Promise<MessageResponse> => {
...
export const getSubmitContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitContact>>, TError,{data: BodyType<ContactBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitContact>>, TError,{data: BodyType<ContactBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitContact>>, {data: BodyType<ContactBody>}> = (props) => {
          const {data} = props ?? {};
